...
=== Forkerd
* Repository merged form Bitbucket to GitHub.
* Template issue field removed from new issue page.
* Description field will be updated when descriptions is not empty. The template will be loaded at first then the existing description information.
